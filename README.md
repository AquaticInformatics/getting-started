...
| AQUARIUS Time-Series 201x | [FieldDataPluginTool.exe](https://github.com/AquaticInformatics/aquarius-field-data-framework/releases/download/v18.1.2/FieldDataPluginTool.exe) | [Here](https://github.com/AquaticInformatics/flowtracker2-field-data-plugin/blob/master/src/FlowTracker2Converter/Readme.md)| You'll need to download and use this GUI tool to install a field data plugins like FlowTracker2. |
